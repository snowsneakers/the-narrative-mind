    ...
    <section className="space-y-5 med:space-y-[30px]">
      ...
      >
        ...
        <p className="text-gray-700">
          Everyone has a story, and every story deserves to be heard with care
          and curiosity. Here are the strengths I bring to our work
          together—guiding you with compassion, collaboration, and respect for
          your unique journey.
        </p>
